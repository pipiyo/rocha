...
<head>
  <title> Informe Bodega sillas V1.0.0</title>
...
<table  id = "formulario">
<tr>
  <th id="tit_bod" height="37" colspan="11" align="center" >Informe Bodega</th>
  </tr>
...
<td colspan='3'></td>
  ...
  <td>
 <input  type="submit" id="buscars" style="width:99%;" name = "buscar" value = "Buscar" />
  </td>
...
<input type="text" value="Bodega" name = "nombreser" id="nombreser" style="display:none;"/>
...
<br />
<center>  
<table id = "informe_bodega" cellpadding="0" cellspacing="0"  style="font-size:9px;width:98%;">
...
if($BUSCAR_CODIGO!='')
{
$query_registro = "select DISTINCT 'servicio.CODIGO_SERVICIO',servicio.FECHA_PRIMERA_ENTREGA, servicio.DIAS,servicio.FECHA_REALIZACION, servicio.RECLAMOS,servicio.CODIGO_SERVICIO,servicio.PREDECESOR, servicio.EJECUTOR, servicio.PROCESO,servicio.FECHA_ENTREGA, proyecto.NOMBRE_CLIENTE, servicio.CODIGO_SERVICIO,servicio.TPTMFI, servicio.DIRECCION, servicio.ESTADO, servicio.SUPERVISOR, servicio.REALIZADOR,servicio.OBSERVACIONES, servicio.DESCRIPCION, proyecto.CODIGO_PROYECTO,servicio.FECHA_INICIO from cliente, servicio, proyecto where  proyecto.CODIGO_PROYECTO = servicio.CODIGO_PROYECTO and servicio.NOMBRE_SERVICIO = 'Bodega' and proyecto.CODIGO_PROYECTO = '".$BUSCAR_CODIGO."' and bodega = 'Despacho' ";
}
else if($CATEGORIA!='' && $ESTADOV =='TODOS')
{
$query_registro = "select DISTINCT 'servicio.CODIGO_SERVICIO',servicio.FECHA_PRIMERA_ENTREGA, servicio.DIAS,servicio.FECHA_REALIZACION, servicio.RECLAMOS,servicio.CODIGO_SERVICIO,servicio.PREDECESOR, servicio.EJECUTOR, servicio.PROCESO,servicio.FECHA_ENTREGA, proyecto.NOMBRE_CLIENTE, servicio.CODIGO_SERVICIO,servicio.TPTMFI, servicio.DIRECCION, servicio.ESTADO, servicio.SUPERVISOR, servicio.REALIZADOR,servicio.OBSERVACIONES, servicio.DESCRIPCION, proyecto.CODIGO_PROYECTO,servicio.FECHA_INICIO from cliente, servicio, proyecto where  proyecto.CODIGO_PROYECTO = servicio.CODIGO_PROYECTO and servicio.NOMBRE_SERVICIO = 'Bodega' and servicio.BODEGA = '".$CATEGORIA."' and bodega = 'Despacho' order by servicio.".$ordenfecha."";
}
else if($CATEGORIA!='')
{
$query_registro = "select DISTINCT 'servicio.CODIGO_SERVICIO',servicio.FECHA_PRIMERA_ENTREGA, servicio.DIAS,servicio.FECHA_REALIZACION, servicio.RECLAMOS,servicio.CODIGO_SERVICIO,servicio.PREDECESOR, servicio.EJECUTOR, servicio.PROCESO,servicio.FECHA_ENTREGA, proyecto.NOMBRE_CLIENTE, servicio.CODIGO_SERVICIO,servicio.TPTMFI, servicio.DIRECCION, servicio.ESTADO, servicio.SUPERVISOR, servicio.REALIZADOR,servicio.OBSERVACIONES, servicio.DESCRIPCION, proyecto.CODIGO_PROYECTO,servicio.FECHA_INICIO from cliente, servicio, proyecto where  proyecto.CODIGO_PROYECTO = servicio.CODIGO_PROYECTO and servicio.NOMBRE_SERVICIO = 'Bodega' and servicio.BODEGA = '".$CATEGORIA."' and servicio.ESTADO = '".$ESTADOV."' and bodega = 'Despacho' order by servicio.".$ordenfecha."";
}
else if($ESTADOV=='TODOS')
{
$query_registro = "select DISTINCT 'servicio.CODIGO_SERVICIO',servicio.FECHA_PRIMERA_ENTREGA,servicio.FECHA_REALIZACION, servicio.DIAS, servicio.RECLAMOS,servicio.CODIGO_SERVICIO,servicio.PREDECESOR, servicio.EJECUTOR, servicio.PROCESO,servicio.FECHA_ENTREGA, proyecto.NOMBRE_CLIENTE, servicio.CODIGO_SERVICIO,servicio.TPTMFI, servicio.DIRECCION, servicio.ESTADO, servicio.SUPERVISOR, servicio.REALIZADOR,servicio.OBSERVACIONES, servicio.DESCRIPCION, proyecto.CODIGO_PROYECTO,servicio.FECHA_INICIO from cliente, servicio, proyecto where  proyecto.CODIGO_PROYECTO = servicio.CODIGO_PROYECTO and servicio.NOMBRE_SERVICIO = 'Bodega' and servicio.FECHA_ENTREGA between '".$txt_desde."' and '".$txt_hasta."' and bodega = 'Despacho' order by servicio.".$ordenfecha."";
}
else if($VENDEDOR!='' && $ESTADOV =='TODOS')
{
$query_registro = "select DISTINCT 'servicio.CODIGO_SERVICIO',servicio.FECHA_PRIMERA_ENTREGA, servicio.DIAS,servicio.FECHA_REALIZACION, servicio.RECLAMOS,servicio.CODIGO_SERVICIO,servicio.PREDECESOR, servicio.EJECUTOR, servicio.PROCESO,servicio.FECHA_ENTREGA, proyecto.NOMBRE_CLIENTE, servicio.CODIGO_SERVICIO,servicio.TPTMFI, servicio.DIRECCION, servicio.ESTADO, servicio.SUPERVISOR, servicio.REALIZADOR,servicio.OBSERVACIONES, servicio.DESCRIPCION, proyecto.CODIGO_PROYECTO,servicio.FECHA_INICIO from cliente, servicio, proyecto where  proyecto.CODIGO_PROYECTO = servicio.CODIGO_PROYECTO and servicio.NOMBRE_SERVICIO = 'Bodega' and proyecto.ejecutivo = '".$VENDEDOR."' and bodega = 'Despacho' order by servicio.".$ordenfecha."";
}
else if($VENDEDOR!='')
{
$query_registro = "select DISTINCT 'servicio.CODIGO_SERVICIO',servicio.FECHA_PRIMERA_ENTREGA, servicio.DIAS,servicio.FECHA_REALIZACION, servicio.RECLAMOS,servicio.CODIGO_SERVICIO,servicio.PREDECESOR, servicio.EJECUTOR, servicio.PROCESO,servicio.FECHA_ENTREGA, proyecto.NOMBRE_CLIENTE, servicio.CODIGO_SERVICIO,servicio.TPTMFI, servicio.DIRECCION, servicio.ESTADO, servicio.SUPERVISOR, servicio.REALIZADOR,servicio.OBSERVACIONES, servicio.DESCRIPCION, proyecto.CODIGO_PROYECTO,servicio.FECHA_INICIO from cliente, servicio, proyecto where  proyecto.CODIGO_PROYECTO = servicio.CODIGO_PROYECTO and servicio.NOMBRE_SERVICIO = 'Bodega' and proyecto.ejecutivo = '".$VENDEDOR."' and servicio.ESTADO = '".$ESTADOV."' and bodega = 'Despacho' order by servicio.".$ordenfecha."";
}

else
{
$query_registro = "select  DISTINCT 'servicio.CODIGO_SERVICIO',servicio.FECHA_PRIMERA_ENTREGA,servicio.FECHA_REALIZACION, servicio.DIAS, servicio.RECLAMOS,servicio.CODIGO_SERVICIO,servicio.PREDECESOR, servicio.EJECUTOR, servicio.PROCESO,servicio.FECHA_ENTREGA, proyecto.NOMBRE_CLIENTE, servicio.CODIGO_SERVICIO, servicio.TPTMFI, servicio.DIRECCION, servicio.ESTADO, servicio.SUPERVISOR, servicio.REALIZADOR,servicio.OBSERVACIONES, servicio.DESCRIPCION, proyecto.CODIGO_PROYECTO,servicio.FECHA_INICIO from cliente, servicio, proyecto where proyecto.CODIGO_PROYECTO = servicio.CODIGO_PROYECTO and servicio.ESTADO = '".$ESTADOV."' and servicio.NOMBRE_SERVICIO = 'Bodega' and servicio.FECHA_ENTREGA between '".$txt_desde."' and '".$txt_hasta."' and bodega = 'Despacho' order by servicio.".$ordenfecha."";
}
...
/*	if($FECHA_VARIABLE == $FECHA_INICIO)
  ...
  //  echo "<tr><td  align='left' colspan='4'><p style='color:#A4A4A4; font-size:15px;'>".$dia."</p></td></tr>";
	echo"<tr>
		 ...
		 <th style='border-top: #E4E4E7 1px solid;border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;width:100px;'><center><a style='color:#fff;text-decoration:none;' id='fechai' href='InformeProyectoBodega.php?buscarfe=INICIO&ESTADO=".$ESTADOV."&buscari=".$buscaf."&txt_desde=".$DESDE."&txt_hasta=".$HASTA."&buscar_codigo=".$BUSCAR_CODIGO."'>Fecha I</a></center></th>
	 <th style='border-top: #E4E4E7 1px solid;border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;width:100px;'><center>Fecha E</center></th>
		 ...
		 <th style='border-top: #E4E4E7 1px solid;border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;width:100px;'><center><a style='color:#fff;text-decoration:none;' id='fechae' href='InformeProyectoBodega.php?buscarfe=ENTREGA&ESTADO=".$ESTADOV."&buscari=".$buscaf."&txt_desde=".$DESDE."&txt_hasta=".$HASTA."&buscar_codigo=".$BUSCAR_CODIGO."'>Fecha C</a></center></th>		
