...
{
mysql_select_db($database_conn, $conn);
$query_registro = "SELECT * FROM PRODUCTO WHERE CODIGO_PRODUCTO = '".$BUSCAR_CODIGO."' OR DESCRIPCION = '".($BUSCAR_DESCRIPCION)."' and CATEGORIA In ('Tela', 'Sillas','Tornillos','Embalaje')  order by DESCRIPCION ASC ";
