 ...
 while($row = mysql_fetch_array($result41))
  {
    ...
    $trd.='<tr><td style="font-size:10PX;" height="20"> 
         ...
         <td style="font-size:10PX;">'.($OBS1).'<br> '.($OBS2). '<br> '.($OBS3). '</td>
 ...
 while($row = mysql_fetch_array($result51))
  {
    ...
    $trd5.='<tr><td style="font-size:10PX;" height="20"> 
	    '.$COD3.'<br> '.$COD4.'<br> '.$COD5.'</td>	
	     <td style="font-size:10PX;">'.($ROCH1).'<br> '.($ROCH2).'<br> '.($ROCH3).'</td>
            <td style="font-size:10PX;" align="left">'.$DES1.'<br> '.$DES2. '<br> '.$DES3.'<br> '.$DESA.  '</td>
         <td style="font-size:10PX;">'.($OBS3).'<br> '.($OBS4).  '<br> '.($OBS5). '</td>
...
<table width="806" border="0" >
  ...
  <tr>
    ...
    <td width="65" style="font-size:15px;">'.($CODIGO_OC).'</td>
    <td width="84">Fecha</td>
    <td width="90">'.($FECHA_REALIZACION).'</td>
  </tr>
  <tr>
    <td>Av. Los conquistadores 2635, Providencia</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>Nombre de fantasia: Multioficina</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<td width="30"> </td>
<td width="408">Muebles & diseño</td>
</tr>
<tr>
...
<table width="806" border="0" >
  <tr>
    <td width="100" rowspan="5"><img src="Imagenes/Rochag.png" style = "border:0px;"></td>
    <td width="270"><h3> Rocha S:A</h3></td>
    <td colspan="4"><h3>Orden de Compra</h3> Pag 2</td>
  </tr>
  <tr>
    <td>Rut 77.003.680-1</td>
    <td width="83">Numero:</td>
...
<table width="806" border="0" >
  <tr>
    <td width="100" rowspan="5"><img src="Imagenes/Rochag.png" style = "border:0px;"></td>
    <td width="270"><h3> Rocha S:A</h3></td>
    <td colspan="4"><h3>Packing List</h3> Pag 2</td>
  </tr>
  <tr>
    <td>Rut 77.003.680-1</td>
    <td width="83">Numero:</td>
...
<table width="806" border="0" >
  <tr>
    <td width="100" rowspan="5"><img src="Imagenes/Rochag.png" style = "border:0px;"></td>
    <td width="270"><h3> Rocha S:A</h3></td>
    <td colspan="4"><h3>Orden de Compra</h3> Pag 3</td>
  </tr>
  <tr>
    <td>Rut 77.003.680-1</td>
    <td width="83">Numero:</td>
...
<table width="806" border="0" >
  <tr>
    <td width="100" rowspan="5"><img src="Imagenes/Rochag.png" style = "border:0px;"></td>
    <td width="270"><h3> Rocha S:A</h3></td>
    <td colspan="4"><h3>Packing List</h3> Pag 3</td>
  </tr>
  <tr>
    <td>Rut 77.003.680-1</td>
    <td width="83">Numero:</td>
...
<table width="806" border="0" >
  <tr>
    <td width="100" rowspan="5"><img src="Imagenes/Rochag.png" style = "border:0px;"></td>
    <td width="270"><h3> Rocha S:A</h3></td>
    <td colspan="4"><h3>Orden de Compra</h3> Pag 4</td>
  </tr>
  <tr>
    <td>Rut 77.003.680-1</td>
    <td width="83">Numero:</td>
...
<table width="806" border="0" >
  <tr>
    <td width="100" rowspan="5"><img src="Imagenes/Rochag.png" style = "border:0px;"></td>
    <td width="270"><h3> Rocha S:A</h3></td>
    <td colspan="4"><h3>Packing List</h3> Pag 4</td>
  </tr>
  <tr>
    <td>Rut 77.003.680-1</td>
    <td width="83">Numero:</td>
...
<table width="806" border="0" >
  <tr>
    <td width="100" rowspan="5"><img src="Imagenes/Rochag.png" style = "border:0px;"></td>
    <td width="270"><h3> Rocha S:A</h3></td>
    <td colspan="4"><h3>Orden de Compra</h3> Pag 5</td>
  </tr>
  <tr>
    <td>Rut 77.003.680-1</td>
    <td width="83">Numero:</td>
...
<table width="806" border="0" >
  <tr>
    <td width="100" rowspan="5"><img src="Imagenes/Rochag.png" style = "border:0px;"></td>
    <td width="270"><h3> Rocha S:A</h3></td>
    <td colspan="4"><h3>Packing List</h3> Pag 5</td>
  </tr>
  <tr>
    <td>Rut 77.003.680-1</td>
    <td width="83">Numero:</td>
