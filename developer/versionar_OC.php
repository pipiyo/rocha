...
<head>
 <title> Versionar OC V1.0.0</title>
...
<div id='bread'><div id="menu1"></div></div>
  <form action = "scriptOCVersionar.php" method="post" id='formulario'>
<div class='content'>
...
<td> 
<input placeholder="Reclamo" value="<?php echo $RECLAMO; ?>" class='textbox' type = "text" id="reclamo" name="reclamo" />
</td>
</tr> 
...
$contador= 1;
 while($row = mysql_fetch_array($result3))
  ...
  $GUIA_DESPACHO= $row["GUIA_DESPACHO"];
   ...
   echo "<tr><td id = 'cel1'> <input autocomplete='off' ondblclick='limpiar(this.id);final();' onblur='final();vagregar(this.id);'  class='form1 codigoproducto' name =cod".$contador." id =cod".$contador." type = 'text' value = '" . 
     $COD_PRODUCTO . "' /></td>"; 
   echo "<td id = 'cel2'> <input autocomplete='off' class='form8 proyecto' onblur='final();vagregar1(this.id);' name =roch".$contador." id =roch".$contador." type = 'text' value = '" . 
      ...
      ($GUIA_DESPACHO) . "' /><input style='display:none;' class='form8' name ='dif".$contador."' id =dif".$contador." type = 'text' value = '" . 
  ...
  echo "<td id = 'cel3'><input autocomplete='off' onblur='final();vagregar(this.id);' class='form2 descripcion' name =des".$contador." id =des".$contador." type = 'text' value = '" . 
   ...
   echo "<td id = 'cel6'><input onblur='total();final();' onkeydown='total();final();' class='form3' id =cant".$contador." name =cant".$contador." type = 'text' value = '" . 
      $CANTIDAD . "' /></td>";
   echo "<td id = 'cel6'><input class='form3' id =um".$contador." name=um".$contador." type = 'text' value = '" . 
      $UNIDAD_DE_MEDIDA . "' /></td>";
  ...
  echo "<td height='30'><input class='form9'   id=resultador".$contador." type = 'text' value = '' /></td>"; 
  echo "<td id = 'cel3'><input autocomplete='off' onblur='final();es_vacio2();vagregar(this.id);' class='form2 descripcion' id =des".$contador." name =des".$contador." type = 'text' value = '' /></td>";
...
<input style="" type = "text" id="codiguito" name="codiguito" value="<?php echo $CODIGO_OC1; ?>" />
