...
<table bordercolor="#ccc" width="960" frame="box" rules="all">
<tr>
...
<option> </option>
  ...
  <tr>
      ...
      <td colspan="1" style=" background-color:#FDE9D9">Tiempo De Producción</td>
      <td  colspan="3" ><input id="txt_val" name="txt_val" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:99%"    value=""></td>
    ...
    <table bordercolor="#ccc" width="960"  border="1" rules="all" id= "tabla_descripcion_radicado">
      <tr>
      ...
      <td width="350" ><input onkeypress="return validar_monto(event)" id="txt_producto1"  name="txt_producto1" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:98%" value="" /></td>
...
<option> </option>
  <option>Jerez</option>
      ...
      <td width="350" ><input onkeypress="return validar_monto(event)" id="txt_producto2"  name="txt_producto2" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:98%" value="" /></td>
      <td width="98" colspan="1" style=" background-color:#FDE9D9">&nbsp;</td>
...
<option> </option>
  <option>Multiple</option>
    ...
    <tr>
      ...
      <td width="350" ><input onkeypress="return validar_monto(event)" id="txt_producto3"  name="txt_producto3" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:98%" value="" /></td>
      <td width="98" colspan="1" style=" background-color:#FDE9D9">&nbsp;</td>
...
<option> </option>
  <option>Multiple</option>
      ...
      <td width="350" ><input onkeypress="return validar_monto(event)" id="txt_producto4"  name="txt_producto4" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:98%" value="" /></td>
      <td width="98" colspan="1" style=" background-color:#FDE9D9">&nbsp;</td>
...
<option> </option>
  <option>Tela</option>
      ...
      <td width="350" ><input onkeypress="return validar_monto(event)" id="txt_producto5"  name="txt_producto5" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:98%" value="" /></td>
      <td width="98" colspan="1" style=" background-color:#FDE9D9">&nbsp;</td>
...
<option> </option>
 ...
 <option>Formica</option>
      ...
      <td width="350" ><input onkeypress="return validar_monto(event)" id="txt_producto6"  name="txt_producto6" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:98%" value="" /></td>
      <td width="98" colspan="1" style=" background-color:#FDE9D9">&nbsp;</td>
...
<option> </option>
 ...
 <select  id="txt_lineac6" name="txt_lineac6" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:31%" ><option> </option>
  <option>Multiple</option>
      ...
      <td width="350" ><input onkeypress="return validar_monto(event)" id="txt_producto7"  name="txt_producto7" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:98%" value="" /></td>
      <td width="98" colspan="1" style=" background-color:#FDE9D9">&nbsp;</td>
...
<option> </option>
 ...
 <select  id="txt_lineac7" name="txt_lineac7" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:31%" ><option> </option>
  <option>Multiple</option>
      ...
      <td width="350" ><input onkeypress="return validar_monto(event)" id="txt_producto8"  name="txt_producto8" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:98%" value="" /></td>
      <td width="98" colspan="1" style=" background-color:#FDE9D9">&nbsp;</td>
...
<option> </option>
 ...
 <select  id="txt_lineac8" name="txt_lineac8" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:31%" ><option> </option>
  <option>Multiple</option>
      ...
      <td width="350" ><input onkeypress="return validar_monto(event)" id="txt_producto9"  name="txt_producto9" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:98%" value="" /></td>
      <td width="98" colspan="1" style=" background-color:#FDE9D9">&nbsp;</td>
...
<option> </option>
 ...
 <select  id="txt_lineac9" name="txt_lineac9" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:31%" ><option> </option>
  <option>Multiple</option>
      ...
      <td width="350" ><input onkeypress="return validar_monto(event)" id="txt_producto10"  name="txt_producto10" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:98%" value="" /></td>
      <td width="98" colspan="1" style=" background-color:#FDE9D9">&nbsp;</td>
      <td colspan="3"> <select  id="txt_lineaa10" name="txt_lineaa10" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:31%" >
<option> </option>
 ...
 <select  id="txt_lineab10" name="txt_lineab10" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:31%" >
<option> </option>
  <option>Italiano</option>
      <option>Bozz Metal</option>
      <option>Melamina</option>
      </select>
 <select  id="txt_lineac10" name="txt_lineac10" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:31%" ><option> </option>
   <option>Italiano</option>
      <option>Bozz Metal</option>
      <option>Melamina</option>
      </select></td>
            ...
            <tr>
      <td width="98" style=" background-color:#FDE9D9;height:25px;"><input   id="txt_produ11" name="txt_produ11" type ="text" style="border:#ccc 1px solid;height:14px; font-size:10px; width:98%" ></td>
      <td width="350" ><input onkeypress="return validar_monto(event)" id="txt_producto11"  name="txt_producto11" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:98%" value="" /></td>
      <td width="98" colspan="1" style=" background-color:#FDE9D9">&nbsp;</td>
      <td colspan="3"> 

<input   id="txt_lineaa11" name="txt_lineaa11" type ="text" style="border:#ccc 1px solid;height:14px; font-size:10px; width:31%" >
 <input   id="txt_lineab11" name="txt_lineab11" type ="text" style="border:#ccc 1px solid;height:14px; font-size:10px; width:31%" >
  <input   id="txt_lineac11" name="txt_lineac11" type ="text" style="border:#ccc 1px solid;height:14px; font-size:10px; width:31%" >
      </tr>
         <tr>
      <td width="98" style=" background-color:#FDE9D9;height:25px;"><input   id="txt_produ12" name="txt_produ12" type ="text" style="border:#ccc 1px solid;height:14px; font-size:10px; width:98%" ></td>
      <td width="350" ><input onkeypress="return validar_monto(event)" id="txt_producto12"  name="txt_producto12" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:98%" value="" /></td>
      <td width="98" colspan="1" style=" background-color:#FDE9D9">&nbsp;</td>
      <td colspan="3"> 

<input   id="txt_lineaa12" name="txt_lineaa12" type ="text" style="border:#ccc 1px solid;height:14px; font-size:10px; width:31%" >
 <input   id="txt_lineab12" name="txt_lineab12" type ="text" style="border:#ccc 1px solid;height:14px; font-size:10px; width:31%" >
  <input   id="txt_lineac12" name="txt_lineac12" type ="text" style="border:#ccc 1px solid;height:14px; font-size:10px; width:31%" >
      </tr>
         <tr>
      <td width="98" style=" background-color:#FDE9D9;height:25px;"><input   id="txt_produ13" name="txt_produ13" type ="text" style="border:#ccc 1px solid;height:14px; font-size:10px; width:98%" ></td>
      <td width="350" ><input onkeypress="return validar_monto(event)" id="txt_producto13"  name="txt_producto13" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:98%" value="" /></td>
      <td width="98" colspan="1" style=" background-color:#FDE9D9">&nbsp;</td>
      <td colspan="3"> 

<input   id="txt_lineaa13" name="txt_lineaa13" type ="text" style="border:#ccc 1px solid;height:14px; font-size:10px; width:31%" >
 <input   id="txt_lineab13" name="txt_lineab13" type ="text" style="border:#ccc 1px solid;height:14px; font-size:10px; width:31%" >
  <input   id="txt_lineac13" name="txt_lineac13" type ="text" style="border:#ccc 1px solid;height:14px; font-size:10px; width:31%" >
      </tr>
