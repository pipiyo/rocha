...
$sql_campos = "DESCRIBE ".$tabla." ";    
$result_campos= mysql_query($sql_campos, $conn) or die(mysql_error());
 while($campos = mysql_fetch_array($result_campos))
  { 


      $relleno .= "<td>".$campos['Field']."</td>";
$i++;

 }

    mysql_free_result($result_campos);



$sql_filas = "SELECT * from ".$tabla." ";    
