...
<div id="main">	
<div id="site_content">
<form enctype="multipart/form-data" action="scriptControlSillasProyectados.php" method="post" name="formulario">
...
<br />
  ...
  color: #1D1D1D; border:grey 1px solid;border-radius: 8px;" name="txt_hasta" id="txt_hasta" type="text" /></th>
    ...
    <tr>
      <td width="133" style=" background-color:#5882FA; height:25px;color:#fff;"">RETAPIZADO</td>
      <td colspan="3"><input  onkeypress="return validar_monto(event)" id="am3"  name="am3" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:98%"   value=""></td>

     
    </tr>
    <tr>
      <td style=" background-color:#099; height:25px;color:#fff;"">TAPIZADO BALDOSA</td>
      <td colspan="3"><input  onkeypress="return validar_monto(event)" id="am4"  name="am4" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:99%"    value=""></td>
     
      </tr>
  
      <td style=" background-color:#060;height:25px;color:#fff;"">TAPIZADO PANTALLA</td>
      <td colspan="3" ><input  onkeypress="return validar_monto(event)"  id="am5"  name="am5" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:98%;background-color:#fff;" value="" /></td>
    ...
    <tr>
      ...
      <td  colspan="3"><input  onkeypress="return validar_monto(event)" id="am6"  name="am6" type ="text" style="border:#fff 1px solid;height:14px; font-size:10px; width:99%;background-color:#fff;"   value=""></td>
