...
<div class='content'>
<form action = "scriptOCeditar.php" method="post" id='formulario'>
...
<td><input type="text" readonly placeholder="Rut Proveedor" class='textbox' id = "folio" name="folio" value = "<?php echo $CODIGO_OC; ?>"/> </td>
...
<td> <input class='textbox' type="text" id = "fecha" name="fecha" value = "<?php echo $FECHA_REALIZACION  ; ?>"/> </td>
<td ><select  class='textbox' onchange="seleccion1()" id = "cond" name = "cond">
<option> Condiciones Pag </option>
<option> A Definir </option>
</select>
</br>
<input class='textbox' VALUE="<?php echo $CONDICION_PAGO; ?>" type="text" id = "condicion" name="condicion"/></td>
</tr>
...
$contador= 1;
 while($row = mysql_fetch_array($result3))
  ...
  echo "<td id = 'cel2'> <input autocomplete='off' class='form8 proyecto' onblur='final();vagregar1(this.id);' name =roch".$contador." id =roch".$contador." type = 'text' value = '" . 
      ($ROCHA) . "' /><input  style='display:none;' class='form8' name ='idi".$contador."' id =idi".$contador." type = 'text' value = '" . 
      ($ID) . "' /><input style='display:none;' class='form8' name ='dif".$contador."' id =dif".$contador." type = 'text' value = '" . 
      ($DIFERENCIA) . "' /><input style='display:none;' class='form8' name ='rec".$contador."' id =rec".$contador." type = 'text' value = '" . 
      ($REC) . "' /></td>"; 
  ...
  echo "<td id = 'cel2'> <input autocomplete='off' class='form8 proyecto' onblur='final();vagregar1(this.id);' name =roch".$contador." id =roch".$contador." type = 'text' value = '' /><input style='display:none;' class='form8' name ='idi".$contador."' id =idi".$contador." type = 'text' value = '' /><input class='form8' style='display:none;' name ='dif".$contador."' id =dif".$contador." type = 'text' value = '0' /><input style='display:none;' class='form8' name ='rec".$contador."' id =rec".$contador." type = 'text' value = '0' /></td>"; 
  echo "<td height='30'><input class='form9'   id=resultador".$contador." type = 'text' value = '' /></td>"; 
  echo "<td id = 'cel3'><input autocomplete='off' onblur='final();vagregar();'  class='form2 descripcion' name =des".$contador." id =des".$contador." type = 'text' value = '' /></td>";
  ...
  echo "<td id = 'cel6'><input class='form3' id =um".$contador."  type = 'text' value = '' /></td>";
...
<tr>
<td colspan="12" rowspan="8"><textarea  name = "obsgeneral" id = "obsgeneral"rows="5" cols="40"><?php echo ($OBSERVACION)?></textarea></td>
</tr>
<tr>
...
<tr>
<td > <select onBlur="total();final();" onChange="total();final();" id = "ivaf" name = "ivaf">
   <option> </option>
...
<tr>
<td width="80" height="30"><input onClick="final()" value = "Realizar"  type="submit" id = "cal" name="cal"/> </td>
</tr>
</table>
