...
<html>
	<head>
		<title>Informe emisión V1</title>
	...
	<form  method="GET"/>
		<div class="box-form">  
			<h1>Listado OC Recibo <?php echo $txt_desde. " / ". $txt_hasta ; ?></h1>    
		  	<table class="table-form">
				...
				<tr>
			  		...
			  		<td align="center">
			  			<a href="excel-emision.php?estado=<?php echo $ES;?>&CODIGO_USUARIO=<?php echo $CODIGO_USUARIO;?>&txt_desde=<?php echo $txt_desde;?>&txt_hasta=<?php echo $txt_hasta; ?>&buscar_usuario=<?php echo $BUSCAR_DESCRIPCION; ?>&buscar_codigo=<?php echo $BUSCAR_CODIGO; ?>&rocha_buscar=<?php echo $BUSCAR_ROCHA; ?>" target="_blank">
