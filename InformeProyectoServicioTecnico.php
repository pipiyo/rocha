...
<head>
  <title> Informe Serv Tec V1.5.1</title>
...
<table  id = "formulario">
<tr>
<th id="tit_ser" height="37" colspan="11" align="center" >Informe Servicio Tecnico</th>
  </tr>
...
<td ><input class="textbox" name="txt_desde" id="txt_desde" type="text" value="<?php echo $DESDE;?>" /></td>
<td >Hasta
</td>
  <td >
...
<td > <input style="font: normal .90em arial, sans-serif;
  color: #1D1D1D; cursor:pointer; color:#FFF;background-color: #960; height:25px;border-radius: 4px; border:#fff 1px solid;width:110px;" type="submit" id="buscar" name = "buscar" value = "Buscar" /> </td>
</td>
...
<tr>
<td ><center>Rocha</center> </td>
<td ><input width="98" class="textbox" type="text" id="buscar_codigo" name="buscar_codigo" value="<?php echo $BUSCAR_CODIGO;?>"  ></td>
...
<td align="center"> <input style="font: normal .90em arial, sans-serif;
  color: #1D1D1D; cursor:pointer; color:#FFF;background-color: #960; height:25px;border-radius: 4px; border:#fff 1px solid; width:110px;" type="button"  value="Informe" onClick="document.formulario.action='InformeActividad.php'; document.formulario.submit();" /><input type="text" value="Servicio Tecnico" name = "nombreser" id="nombreser" style="display:none;"/> </td>
...
<br />
<center>  
<table  id = "informe_servicio" cellpadding="0" cellspacing="0"  style="font-size:9px; width:98%;">
<?php
...
mysql_select_db($database_conn, $conn);
////Comienzo
$query_registro = "select DISTINCT 'servicio.CODIGO_SERVICIO',servicio.FECHA_PRIMERA_ENTREGA,servicio.DOCUMENTO_SERVICIO_TECNICO,servicio.FECHA_REALIZACION, servicio.RECLAMOS,servicio.TIPO_SERVICIO,servicio.TECNICO_1,servicio.TECNICO_2, servicio.DIAS,servicio.CODIGO_SERVICIO,servicio.PREDECESOR, servicio.EJECUTOR, servicio.PROCESO,servicio.FECHA_ENTREGA, proyecto.NOMBRE_CLIENTE, servicio.CODIGO_SERVICIO,servicio.TPTMFI, servicio.DIRECCION, servicio.ESTADO, servicio.SUPERVISOR, servicio.REALIZADOR,servicio.OBSERVACIONES, servicio.DESCRIPCION, proyecto.CODIGO_PROYECTO,servicio.FECHA_INICIO  from  servicio, proyecto where  proyecto.CODIGO_PROYECTO = servicio.CODIGO_PROYECTO and servicio.NOMBRE_SERVICIO = 'Servicio Tecnico' ";	
   ...
   // echo "<tr><td  align='left' colspan='4'><p style='color:#A4A4A4; font-size:15px;'>".$dia."</p></td></tr>";
	echo"<tr>
         ...
         <th style='border-top: #E4E4E7 1px solid;border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;'><center>Observaciones</center></th>
			 <th style='border-top: #E4E4E7 1px solid;border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;width:100px;'><center><a style='color:#fff;text-decoration:none;' id='fechai' href='InformeProyectoServicioTecnico.php?buscarfe=INICIO&ESTADO=".$ESTADOV."&buscari=".$buscaf."&txt_desde=".$DESDE."&txt_hasta=".$HASTA."&buscar_codigo=".$BUSCAR_CODIGO."'>Fecha I</a></center></th>
		 ...
		 <th style='border-top: #E4E4E7 1px solid;border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;width:100px;'><center><a style='color:#fff;text-decoration:none;' id='fechae' href='InformeProyectoServicioTecnico.php?buscarfe=ENTREGA&ESTADO=".$ESTADOV."&buscari=".$buscaf."&txt_desde=".$DESDE."&txt_hasta=".$HASTA."&buscar_codigo=".$BUSCAR_CODIGO."'>Fecha C</a></center></th>
	...
	{
    echo  "<tr><td style='border-left:#E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;width:100px;height:20px;background:#39C;'><center> <a id='cod_ser' target='_blank' href=editarProyecto.php?CODIGO_PROYECTO=". urlencode($CODIGO_PROYECTO).">" . $CODIGO_PROYECTO . "</a></td>";
	...
	echo  "<td style='border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;background:#39C;'><center>".($DOCUMENTO)."</center></td>";
	echo  "<td style='border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;background:#39C;'>".($NOMBRE_CLIENTE)."</td>";
	echo  "<td  style='border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;background:#39C;'>".($SERVICIO)."</td>";
...
//	echo  "<td style='border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;'>".($SUPERVISOR)."</td>";
	echo  "<td style='border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;background:#39C;'>".($TECNICO1)."</td>";
	echo  "<td style='border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;background:#39C;'>".($TECNICO2)."</td>";
	...
	{
		   echo  "<tr><td style='border-left:#E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;width:100px;height:20px;'><center> <a id='cod_ser' target='_blank' href=editarProyecto.php?CODIGO_PROYECTO=". urlencode($CODIGO_PROYECTO).">" . $CODIGO_PROYECTO . "</a></td>";
	...
	//echo  "<td style='border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;'>".($PREDECESOR)."</td>";
	echo  "<td style='border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;'><center>".($DOCUMENTO)."</center></td>";
