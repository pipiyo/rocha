<?php
      ...
      function comprobar($b) {
            ...
            $query_registro = "SELECT * FROM cliente WHERE RUT_CLIENTE ='".$b."'";
            ...
            if($contar == 0){
                  ...
                  echo "<input onclick='abrircli()' style='float:right;  color: #ffffff; cursor: pointer; border: 0px; background:#6699FF; height:25px;'  id='Ingresar' name='Ingresar' type='button' value='Cliente desconocido ¿Desea crear cliente?'  />";
