...
<form  id = 'formulario11' method="GET" action="scriptActualizarServicioReclamo.php"/>
<div onMouseMove="fecha();">
<table>
<tr>
<td width="">Nombre</td>
<td width="" ><input style="  width:142px; font: normal .90em arial, sans-serif;
  color: #1D1D1D; border:grey 1px solid;border-radius: 8px;" type="text" name = "txt_nombre_servicio" value="<?php echo $NOMBRE_SERVICIO1 ?>"> <input style="display:none;" type="text" name = "txt_codigo" value="<?php echo $CODIGO_SERVICIO1 ?>"> <input style="display:none;" type="text" name = "txt_codigo_proyecto" value="<?php echo $CODIGO_PROYECTO ?>"><br></td>
</tr>
<tr>
...
<td width="" ><input onchange="dias1();" style="  width:142px; font: normal .90em arial, sans-serif;
  color: #1D1D1D; border:grey 1px solid;border-radius: 8px;" type="text" id = 'txt_fechai' name = "txt_fechai"  value="<?php echo ($FECHA_I1); ?>"> <br></td>
</tr>
<tr>
<td width="">Fecha entrega</td>
<td width="" ><input onchange="dias1();" style="  width:142px; font: normal .90em arial, sans-serif;
  color: #1D1D1D; border:grey 1px solid;border-radius: 8px;" type="text" id = 'txt_fechae' name = "txt_fechae"  value="<?php echo ($FECHA_E1); ?>"></td>
</tr>
<tr>
<td width="">Dias</td>
<td width="" ><input onchange="dias1();" style="  width:142px; font: normal .90em arial, sans-serif;
...
<td width="" ><select style="width:142px; font: normal .90em arial, sans-serif;
  color: #1D1D1D; border-radius: 8px;"   id = "txt_estado" name = "txt_estado">
