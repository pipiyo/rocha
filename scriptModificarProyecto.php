...
$sql6="UPDATE proyecto SET TIPO_PROYECTO   ='".$TIPO_PROYECTO ."', MERCADO  ='".$MERCADO."',EMPRESA ='".$EMPRESA ."', NOMBRE_CLIENTE='".$CLIENTE."',RUT_CLIENTE='".$RUT."',CODIGO_CLIENTE ='".$CODIGO_CLIENTE."',OBRA='".$OBRA."',DIRECCION_FACTURACION='".$DIRECCION_OBRA."', ORDEN_CC='".$OC."',CONDICION_PAGO='".$CONDICION_PAGO."',DEPARTAMENTO_CREDITO='".$DEPARTAMENTO_CREDITO."', EJECUTIVO='".($DIRECTOR)."',DISENADOR='".($DISENADOR)."', CONTACTO='".$CONTACTO."',FONO='".$FONO."', MAIL='".$MAIL."',VALIDEZ_COTIZACION='".$VALIDEZ."', PUESTOS='".$PUESTOS."',SUB_TOTAL='".$SUB_TOTAL1."',DESCUENTO='".$DESCUENTO1."',FECHA_INGRESO='".$FECHA_INGRESO."', DIAS='".$DIAS_RADICADO."',FECHA_ENTREGA='".$FECHA_ENTREGA."',ESTADO='".$ESTADO."',TOTAL='".$TOTAL."',IVA='".$IVA."',TIPO_IVA ='".$TIPO_IVA."',FECHA_ACTA='".$FECHA_ACTA."',DESCUENTO2='".$DESCUENTO3."', MONTO2='".$NETOB."', MONTO='".$NETOA."',TIEMPO_ESPECIAL='".$ESPECIAL."',CONVENIR='".$CONVENIR."' ,ENCARGADO='".$ENCARGADO."' ,NOMBRE_PROYECTO='".$NOMBRE_PROYECTO."' WHERE CODIGO_PROYECTO = '".$CODIGO_RADICADO."'"; 
