...
<head>
  <title> Informe Mantencion V1.2.0</title>
...
<table  id = "formulario">
<tr>
  <th id="tit_man" height="37" colspan="11" align="center" >Informe Mantencion</th>
  </tr>
...
<td align=""> <input style="font: normal .90em arial, sans-serif;
  color: #1D1D1D; cursor:pointer; color:#FFF;background-color: #909; height:25px;border-radius: 4px; border:#fff 1px solid;" type="submit" id="buscar" name = "buscar" value = "Buscar" /> </td>
...
<td width=""><input width="98" class="textbox"  type="text" id="buscar_codigo" name="buscar_codigo" value="<?php echo $BUSCAR_CODIGO;?>"  ></td>
...
<td align="center"> <input style=" color:#000;background-color:#909;color:#FFF; height:25px;border-radius: 3px; width:100px; border:#fff 1px solid;" type="button"  value="Informe" onClick="document.formulario.action='InformeActividad.php'; document.formulario.submit();" /><input type="text" value="Mantencion" name = "nombreser" id="nombreser" style="display:none;"/> </td>
...
<table id = "informe_mantencion" cellpadding="0" cellspacing="0"  style="font-size:9px; width:98%;">
<?php
...
$query_registro = "select DISTINCT 'servicio.CODIGO_SERVICIO',servicio.OC,servicio.CANTIDAD,servicio.FECHA_PRIMERA_ENTREGA,servicio.FECHA_REALIZACION, servicio.DIAS, servicio.RECLAMOS,servicio.CODIGO_SERVICIO,servicio.PREDECESOR, servicio.EJECUTOR, servicio.PROCESO,servicio.FECHA_ENTREGA, proyecto.NOMBRE_CLIENTE, servicio.CODIGO_SERVICIO,servicio.TPTMFI, servicio.DIRECCION, servicio.ESTADO, servicio.SUPERVISOR, servicio.REALIZADOR,servicio.OBSERVACIONES, servicio.DESCRIPCION, proyecto.CODIGO_PROYECTO,servicio.FECHA_INICIO  from  servicio, proyecto where proyecto.CODIGO_PROYECTO = servicio.CODIGO_PROYECTO and servicio.NOMBRE_SERVICIO = 'MANTENCION' ";	
	...
	echo"<tr>
	 ...
	 <th style='border-top: #E4E4E7 1px solid;border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;width:100px;'><center><a style='color:#fff;text-decoration:none;' id='fechai' href='InformeProyectoSilla.php?buscarfe=INICIO&ESTADO=".$ESTADOV."&buscari=".$buscaf."&txt_desde=".$DESDE."&txt_hasta=".$HASTA."&buscar_codigo=".$BUSCAR_CODIGO."'>Fecha I</a></center></th>
	  <th style='border-top: #E4E4E7 1px solid;border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;width:100px;'><center>Fecha E</center></th>
		 <th style='border-top: #E4E4E7 1px solid;border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;width:100px;'><center><a style='color:#fff;text-decoration:none;' id='fechae' href='InformeProyectoMantencion.php?buscarfe=ENTREGA&ESTADO=".$ESTADOV."&buscari=".$buscaf."&txt_desde=".$DESDE."&txt_hasta=".$HASTA."&buscar_codigo=".$BUSCAR_CODIGO."'>Fecha C</a></center></th>
...
echo  "<td align='center' style='border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;background:#FFFF00;'>".substr($FECHA_ENTREGA,0,11)."</td>";		
	...
	echo  "<td  align='center' style='border-left: #E4E4E7 1px solid;border-bottom: #E4E4E7 1px solid;'>".substr($FECHA_PRIMERA_ENTREGA,0,11)."</td>";		
