...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
  ...
  <head>
  <title> Informe Abastecimiento V2.1.0</title>
...
<td>
<a href="ExcelInformeAbastecimiento.php?txt_desde=<?php echo $txt_desde;?>&txt_hasta=<?php echo $txt_hasta;?>&ESTADO=<?php echo urlencode($ESTADOV);?>&buscarfe=<?php echo urlencode($buscaf);?>&buscar_codigo=<?php echo urlencode($BUSCAR_CODIGO);?>&buscar_vendedor=<?php echo urlencode($BUSCAR_VENDEDOR);?>&categoria=<?php echo urlencode($CATEGORIA);?>&PROCESO=<?php echo urlencode($PROCESO);?>" target="_blank">
...
<table rules='all' frame='box' class='adquisi fixed'>
<?php
...
$query_registro = "select DISTINCT 'servicio.CODIGO_SERVICIO', servicio.FECHA_PRIMERA_ENTREGA,servicio.FI, servicio.CODIGO_SERVICIO, servicio.RECLAMOS,servicio.PUESTOS,servicio.DIAS,servicio.LIDER,servicio.INSTALADOR_4,servicio.INSTALADOR_3,servicio.FECHA_REALIZACION,servicio.INSTALADOR_2,servicio.INSTALADOR_1, servicio.GUIA_DESPACHO, proyecto.NOMBRE_CLIENTE, servicio.CODIGO_SERVICIO,servicio.TPTMFI, servicio.DIRECCION, servicio.ESTADO, servicio.SUPERVISOR, servicio.REALIZADOR,servicio.OBSERVACIONES, servicio.DESCRIPCION, proyecto.CODIGO_PROYECTO,servicio.FECHA_ENTREGA,servicio.FECHA_INICIO,servicio.CODIGO_COMUNA,proyecto.DEPARTAMENTO_CREDITO from servicio, proyecto where  proyecto.CODIGO_PROYECTO = servicio.CODIGO_PROYECTO  and servicio.NOMBRE_SERVICIO = 'ADQUISICIONES' ";
