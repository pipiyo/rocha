...
<head>
  <title>Bodega despachoV1.0.0</title>
...
<option> Tornillos </option>
 ...
 <td>
<a target='_blank' href="Producto-quiebre-despacho.php">
<div id='qd'><h3 id='hquiebre'> <center> Quiebre </center></h3></div>
</a>
</td>     
      
<td>
<a target='_blank' href="producto-quiebre-disponible-despacho.php?valor=0">
...
<?php if($CODIGO_USUARIO == '1' || $CODIGO_USUARIO == '20' || $CODIGO_USUARIO == '14'|| $CODIGO_USUARIO == '32' || $CODIGO_USUARIO == '24'|| $CODIGO_USUARIO == '126')  { ?>
...
{
$query_registro = "SELECT * FROM PRODUCTO WHERE CODIGO_PRODUCTO = '".$BUSCAR_CODIGO."' and CATEGORIA In ('Accesorios', 'Actiu','Cajoneras','Cristales','Embalaje','Full space','Mantencion','Mueble de linea','Paneleria','Producto especial','Quincalleria','Servicios','Sillas','Soportes','Superficies curvas','Superficies rectas')order by DESCRIPCION ASC ";
}
else if($BUSCAR_CODIGO == "" && $BUSCAR_DESCRIPCION  != "" && $familias == "")
{
$query_registro = "SELECT * FROM PRODUCTO WHERE CODIGO_PRODUCTO = '".$BUSCAR_CODIGO."' OR  DESCRIPCION LIKE '%".($BUSCAR_DESCRIPCION)."%' and CATEGORIA In ('Accesorios', 'Actiu','Cajoneras','Cristales','Embalaje','Full space','Mantencion','Mueble de linea','Paneleria','Producto especial','Quincalleria','Servicios','Sillas','Soportes','Superficies curvas','Superficies rectas') order by DESCRIPCION ASC ";
...
{
$query_registro = "SELECT * FROM PRODUCTO WHERE CATEGORIA = '".$familias."' and CATEGORIA In ('Accesorios', 'Actiu','Cajoneras','Cristales','Embalaje','Full space','Mantencion','Mueble de linea','Paneleria','Producto especial','Quincalleria','Servicios','Sillas','Soportes','Superficies curvas','Superficies rectas') order by DESCRIPCION ASC ";
}
else if($BUSCAR_CODIGO != "" && $BUSCAR_DESCRIPCION  != "" && $familias == "")
{
$query_registro = "SELECT * FROM PRODUCTO WHERE CODIGO_PRODUCTO = '".$BUSCAR_CODIGO."' and CATEGORIA In ('Accesorios', 'Actiu','Cajoneras','Cristales','Embalaje','Full space','Mantencion','Mueble de linea','Paneleria','Producto especial','Quincalleria','Servicios','Sillas','Soportes','Superficies curvas','Superficies rectas') order by DESCRIPCION ASC ";
...
{
$query_registro = "SELECT * FROM PRODUCTO WHERE CATEGORIA = '".$familias."' OR  DESCRIPCION LIKE '%".($BUSCAR_DESCRIPCION)."%' and CATEGORIA In ('Accesorios', 'Actiu','Cajoneras','Cristales','Embalaje','Full space','Mantencion','Mueble de linea','Paneleria','Producto especial','Quincalleria','Servicios','Sillas','Soportes','Superficies curvas','Superficies rectas')  order by DESCRIPCION ASC ";
}
}
else
{
...
<th><center>Minimo</center></th>
<th><center>Maximo</center></th>";
	if($CODIGO_USUARIO == '1' || $CODIGO_USUARIO == '20' || $CODIGO_USUARIO == '14'|| $CODIGO_USUARIO == '32' || $CODIGO_USUARIO == '24'|| $CODIGO_USUARIO == '126')  {
		echo" 
<th><center>Ingreso</center></th>
<th><center>Egreso</center></th>";
	}
